    ...
    return (
        <div className="min-h-screen bg-slate-50/50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                {/* Main Card */}
                <div className="bg-white shadow-2xl shadow-slate-200/60 rounded overflow-hidden border border-slate-100">
                        ...
                        <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 sm:left-12 sm:translate-x-0">
                            <div className="relative">
                                <img
                                    ...
                                    alt="Profile"
                                    className="h-32 w-32 sm:h-40 sm:w-40 rounded border-4 border-white object-cover shadow-2xl rotate-3 hover:rotate-0 transition-all duration-300"
                                />
                    ...
                    <div className="pt-20 pb-10 px-6 sm:px-12">
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
                            <div className="text-center sm:text-left">
                                ...
                                <div className="flex flex-wrap justify-center sm:justify-start gap-2 mt-2">
                                    <span className={`flex items-center gap-2 px-3 py-1  text-xs font-black uppercase tracking-widest border
                                    ...
                                    <span className="px-3 py-1 bg-slate-100 text-slate-500  text-xs font-bold uppercase tracking-widest border border-slate-200">
                                        Verified Member
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-6">
                                ...
                                <div className="group flex items-center gap-4 p-4 rounded border border-slate-50 bg-slate-50/30 hover:bg-white hover:border-slate-200 hover:shadow-sm transition-all">
                                    <div className="p-3 bg-white rounded shadow-sm text-indigo-500 group-hover:scale-110 transition-transform">
                                        <FaEnvelope />
                                    </div>
                                    <div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-5 rounded bg-indigo-600 text-white shadow-xl shadow-indigo-200">
